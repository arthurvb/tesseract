...
{
    class OSXLibraryLoaderLogic : ILibraryLoaderLogic
    {
        public IntPtr LoadLibrary(string fileName)
        {
            ...
            try
            {
                ...
                libraryHandle = OSXLoadLibrary(fileName, RTLD_NOW);
